        ...
        <div>
            ...
            <div className="max-w-4xl">
                <Paragraph className=" mt-4">
                    Hey there, I&apos;m Hassan Ahmed - a Experienced Full Stack Web and Mobile App Developer with a successful track record at byDesign,
                    Labaraka, NewsIn, Grilsontop, and Drivingplates. Proven problem-solver, adept at tackling diverse
                    programming challenges to ensure seamless functionality.
                    <br />
                    Specializing in React JS, Next JS, Node JS, MongoDB, MySQL, Redis, React Native, Express JS, and Socket.io.
                    <br />
                    I bring a comprehensive skill set to enhance your projects. Elevate your digital ventures with my expertise and drive business success through innovative, user-focused solutions.
                </Paragraph>
                <Paragraph className=" mt-4">
